...
module.exports = {
  ...
  included() {
    ...
    this.app = app;
    this.addonConfig = this.app.project.config(app.env)['ember-mirage'] || {};
    this.addonBuildConfig = this.app.options['ember-mirage'] || {};
  ...
  treeFor(name) {
    ...
    if (name === 'app') {
      ...
      return writeFile('initializers/ember-mirage.js', `
        export default {
          name: 'ember-mirage',
          initialize() {}
        };
